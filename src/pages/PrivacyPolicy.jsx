...
const sections = [
  ...
  },
  {
    ...
    list: [
      ...
      'Arrive on the Website from a search result, another site, or an advertisement. Unless you opt out of campaign statistics, we keep first-party UTMs, the first page you opened, the page you were on when you sent an enquiry, and the referring website. Advertising click IDs (gclid, gbraid, wbraid, fbclid) are only stored if you have allowed advertising cookies.',
  ...
  },
  {
    ...
    list: [
      ...
      'First-party enquiry attribution stored with a contact form you submit: UTM parameters, landing page, first landing page of the visit, and referrer, unless you opt out of campaign statistics in the cookie banner. Advertising click IDs (gclid, gbraid, wbraid, fbclid) are stored only if you have allowed advertising cookies. Missing values are stored as null. We do not send these fields to Google or Meta from the form; Google Analytics, Google Ads, and Meta measurement continue separately under the Cookie Policy where you have consented.',
  ...
  },
  {
    ...
    list: [
      ...
      'Record first-party campaign and landing-page details with each enquiry so we can see where a lead came from, even if Google Analytics, Google Ads, or Meta have not attributed it yet. You can opt out of campaign statistics in the cookie banner. Advertising click IDs are only stored if you allow advertising cookies.',
  ...
  },
  {
    ...
    body: [
      ...
      'You can opt out of first-party campaign statistics (UTMs, landing page, and referrer) in the cookie banner under Customise. Advertising click IDs are not stored unless you allow Advertising.',
