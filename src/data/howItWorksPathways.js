...
// Session times also live in public/llms.txt. Keep both in sync.

export const CHILD_STEPS_AUTISM = [
  {
  ...
  {
    title: 'Report and Feedback Session (30 minutes)',
...
export const CHILD_STEPS_COMBINED = [
  {
    title: 'Online questionnaires (60+ minutes)',
  ...
  {
    title: 'Parent/carer interview (150 minutes)',
  ...
  {
    title: 'Report and feedback session (under 45 minutes)',
...
export const ADULT_STEPS_AUTISM = [
  {
    title: 'Online questionnaires (60 minutes)',
...
export const ADULT_STEPS_COMBINED = [
  {
    title: 'Online questionnaires (60 minutes)',
  ...
  {
    title: 'Personal interview (150 minutes)',
...
export const PATHWAY_LABELS = {
  ...
  combined: {
    child: 'Child combined autism and ADHD',
    adult: 'Adult combined autism and ADHD',
  },
}

export const HOW_IT_WORKS_PATHWAYS = [
  { id: 'child-autism', assessment: 'autism', audience: 'child' },
  { id: 'child-adhd', assessment: 'adhd', audience: 'child' },
  { id: 'child-combined', assessment: 'combined', audience: 'child' },
  { id: 'adult-autism', assessment: 'autism', audience: 'adult' },
  { id: 'adult-adhd', assessment: 'adhd', audience: 'adult' },
  { id: 'adult-combined', assessment: 'combined', audience: 'adult' },
].map((pathway) => ({
  ...pathway,
  label: PATHWAY_LABELS[pathway.assessment][pathway.audience],
  steps: FLOWS[pathway.assessment][pathway.audience],
}))
...
export function buildHowItWorksJsonLd() {
  return {
    ...
    name: 'How Nova Clinics assessments work',
    url: `${SITE_ORIGIN}/#how-it-works`,
    itemListElement: HOW_IT_WORKS_PATHWAYS.map((pathway, index) => ({
      '@type': 'ListItem',
      position: index + 1,
      item: {
        '@type': 'HowTo',
        name: `${pathway.label} assessment`,
        url: `${SITE_ORIGIN}/#how-it-works`,
        step: pathway.steps.map((step, stepIndex) => ({
          '@type': 'HowToStep',
