    ...
    collections: [
      {
        ...
        ui: {
          router: ({ document }) => {
            const slug = String((document as unknown as { slug?: string })?.slug || '').trim()
        ...
        fields: [
          ...
          },
          {
            ...
            label: 'Slug (URL)',
            description:
              'SEO-friendly, unique slug (lowercase, hyphens). Must not duplicate another post.',
            required: true
          },
          {
            type: 'string',
          ...
          },
          {
            ...
            required: true,
            description:
              'Examples: Autism, ADHD, Combined, Children, Adults, NHS & Updates, General guidance.'
          },
          {
            type: 'string',
            name: 'tags',
